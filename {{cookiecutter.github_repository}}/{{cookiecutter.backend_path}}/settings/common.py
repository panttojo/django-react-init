...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {"anon": "100/second"},
...
STATIC_ROOT = env("STATIC_ROOT", default=str(ROOT_DIR.path(".staticfiles")))
...
MEDIA_ROOT = env("MEDIA_ROOT", default=str(ROOT_DIR.path(".media")))
