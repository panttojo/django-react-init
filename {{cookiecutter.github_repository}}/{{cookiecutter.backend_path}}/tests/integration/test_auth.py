...
def test_user_registration(client):
    ...
    credentials = {"username": "panttojo", "email": "test@test.com", "password": "localhost"}
...
def test_user_login(client):
    ...
    u = f.create_user(username="panttojo", email="test@example.com", password="test")
...
def test_user_password_change(client):
    ...
    user = f.create_user(username="username", email="test@example.com", password=current_password)
...
def test_user_password_reset(client, mailoutbox, settings):
    ...
    user = f.create_user(username="panttojo", email="test@example.com")
